...
TEST_CASE( "Input 2", "Template" ) {
    ...
    REQUIRE(test_output_text== "21");
}

TEST_CASE( "Input 3", "Template" ) {
    stringbuf test_input("5", ios_base::in);
    stringbuf test_output(ios_base::out);
    streambuf *const cin_buf = cin.rdbuf(&test_input);
    streambuf *const cout_buf = cout.rdbuf(&test_output);
    ...
    REQUIRE(test_output_text== "60");
}
TEST_CASE( "Input 6", "Template" ) {
    stringbuf test_input("6", ios_base::in);
    stringbuf test_output(ios_base::out);
    streambuf *const cin_buf = cin.rdbuf(&test_input);
    streambuf *const cout_buf = cout.rdbuf(&test_output);
    ...
    REQUIRE(test_output_text== "183");
}

TEST_CASE( "Input 30", "Template" ) {
    stringbuf test_input("30", ios_base::in);
    stringbuf test_output(ios_base::out);
    streambuf *const cin_buf = cin.rdbuf(&test_input);
    streambuf *const cout_buf = cout.rdbuf(&test_output);
    ...
    REQUIRE(test_output_text== "782663359");
}
